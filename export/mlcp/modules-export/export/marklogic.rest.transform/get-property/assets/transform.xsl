...
--><xsl:stylesheet version="2.0" extension-element-prefixes="xdmp" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:map="http://marklogic.com/xdmp/map" xmlns:xdmp="http://marklogic.com/xdmp">
