...
--><!-- %roxy:params("highlight=xs:string?") --><xsl:stylesheet version="2.0" extension-element-prefixes="xdmp" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ingest="http://marklogic.com/ingest" xmlns:json="http://marklogic.com/xdmp/json" xmlns:map="http://marklogic.com/xdmp/map" xmlns:util="http://marklogic.com/utilities" xmlns:xdmp="http://marklogic.com/xdmp" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema">
